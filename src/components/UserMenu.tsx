...
export default function UserMenu({ session }: UserMenuProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 rounded-xl bg-[#1a1a2e]/95 backdrop-blur-xl border border-white/10 shadow-xl shadow-black/50 py-2 z-[9999] animate-fade-in">
          {/* User info header */}
