...
describe('SandboxToolExecutor', () => {
  ...
  describe('execCommand', () => {
    it('should delegate to sandbox.exec and return result', async () => {
      ...
      expect(mockSandbox.exec).toHaveBeenCalledWith('echo test', undefined, expect.any(Function));
    ...
    it('should pass workdir to sandbox.exec', async () => {
      ...
      expect(mockSandbox.exec).toHaveBeenCalledWith('ls', './src', expect.any(Function));
    });
